    ...
    <div className="overflow-x-auto w-full">
     ...
     <h1 className="text-3xl font-bold mb-6">Class Advisory</h1>
      ...
      <div className="bg-white rounded shadow p-4 mb-6">
        <p className="mb-2">
          <span className="font-semibold">Grade:</span> 11
        </p>
        <p className="mb-2">
          <span className="font-semibold">Section:</span> Newton
        </p>
        <p className="mb-2">
          <span className="font-semibold">Number of Students:</span> 5
        </p>
        <p>
          <span className="font-semibold">Class Advisor:</span>{" "}
          <span className="font-bold">Mr. Albert Einstein</span>
        </p>
      </div>
        ...
        <div className="p-8">
          ...
          <div className="bg-white shadow rounded-lg p-4 max-w-screen-lg mx-auto">
           <div className="mb-4">
           <button className="bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded-md ml-4">Request to Validate</button>
           </div>
