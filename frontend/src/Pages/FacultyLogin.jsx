        ...
        <div className="flex flex-col md:flex-row items-center md:justify-between">
          ...
          <div className="w-full max-w-md">
            <div className="p-8 rounded-2xl bg-white shadow-md">
              <img src={Logo} className="w-24 h-24 md:w-32 md:h-32 mx-auto" alt="Logo" />
              <h2 className="text-green-700 text-center text-xl md:text-2xl font-bold mt-4">FACULTY PORTAL</h2>
              ...
              <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-end">
                  <a
                    href="#"
                    className="text-gray-400 hover:underline font-semibold text-sm"
                  >
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 text-sm rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none"
                >
                  Sign in
                </button>
              </form>
