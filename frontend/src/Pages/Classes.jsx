...
const Classes = () => {
  ...
  const fetchUser = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:3000/auth/faculty-classes", {
         ...
         {/* Manage Students Content */}
                 <div className="p-8">
                   ...
                   <div className="bg-white shadow rounded-lg p-4 max-w-screen-lg mx-auto">
                     ...
                     <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md ml-4">Add Student</button>
                     <button className="bg-green-700 hover:bg-green-600 text-white px-4 py-2 rounded-md ml-4">Archive Student</button>
