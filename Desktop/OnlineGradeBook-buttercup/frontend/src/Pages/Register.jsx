...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!values.FacultyID || !values.FirstName || !values.Email || !values.Password) {
      ...
      <div className='shadow-lg px-8 py-5 border w-96'>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="text" name="FacultyID" placeholder='Enter Faculty ID' className='w-full px-3 py-2 border' onChange={handleChanges} />
          </div>
          <div className="mb-4">
        ...
        <div className="text-center mt-4">
          ...
          <Link to='/faculty-login' className='text-blue-500'>Login</Link>
        </div>
      </div>
    </div>
  );
